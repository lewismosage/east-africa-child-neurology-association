  ...
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-lg text-gray-600 mb-12">Making a real difference in child neurology care across East Africa</p>
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => (
            <div key={stat.label} className="p-8 bg-white rounded-2xl shadow-lg">
              <div className={`w-16 h-16 flex items-center justify-center rounded-xl bg-gradient-to-r ${stat.color} mb-4`}>
